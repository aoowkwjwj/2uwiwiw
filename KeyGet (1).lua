...
-- Hàm lưu khóa vào PlayerData
function saveKey(key)
    local HttpService = game:GetService("HttpService")
    local player = game.Players.LocalPlayer
    local keyData = { key = key }
    local jsonData = HttpService:JSONEncode(keyData)
    
    if writefile then
        local foldername = "PlayerData"
        local filepath = foldername .. "/" .. player.UserId .. "_key.json"
...
-- Hàm tải khóa đã lưu từ PlayerData
function loadKey()
    local HttpService = game:GetService("HttpService