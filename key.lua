...
--! configuration
local service = 3157;  -- your service id, this is used to identify your service.
local secret = "41f00346-8dcc-4bd5-87ec-264115c10531";  -- make sure to obfuscate this if you want to ensure security.
...
titleText.BackgroundColor3 = Color3.fromRGB(0, 0, 255)
titleText.BackgroundTransparency = 1.000
titleText.Position = UDim2.new(0, 5, 0, 0)
titleText.Size = UDim2.new(0, 0, 0, 25)
titleText.Font = Enum.Font.GothamBold
titleText.Text = "Blue X Hub               "
...
lineFrame.BackgroundColor3 = Color3.fromRGB(0, 0, 255)
...
strokeKeyFrame.Color = Color3.fromRGB(0, 0, 255)
...
checkKeyFrame.BackgroundColor3 = Color3.fromRGB(0, 0, 255)
...
buttonCheckKey.BackgroundColor3 = Color3.fromRGB(0, 0, 255)
...
-- Kiểm tra key đã lưu trong Player khi bật script
local playerKey = game.Players.LocalPlayer:GetAttribute("PlayerKey")
if playerKey then
    local success = verifyKey(playerKey)
    if success then
        print("Key hợp lệ, tự động đăng nhập.")
        loadstring(game:HttpGet("https://raw.githubusercontent.com/ShibaCoBoNhi/Obi/refs/heads/main/freemium.lua"))()
    else
        print("Key không hợp lệ, vui lòng nhập lại.")
    end
else
    print("Chưa có key, vui lòng nhập key.")
end
...
buttonCheckKey.MouseButton1Click:Connect(function()
    ...
    if success then
        -- Lưu key vào Player
        game.Players.LocalPlayer:SetAttribute("PlayerKey", key)
        keyBox.PlaceholderText = "Success Key!"
        keyBox.Text = ""
        wait(2)
        mainFrame:Destroy()
        print("Chìa khóa có giá trị.")
        loadstring(game:HttpGet("https://raw.githubusercontent.com/ShibaCoBoNhi/Obi/refs/heads/main/freemium.lua"))()
    else
        print("Chìa khóa không hợp lệ..")
    end
end)