    ...
    while task.wait() do
        if _G.FullyKoko then
            if game:GetService("Workspace").Enemies:FindFirstChild("Order") then
                ...
                topos(CFrame.new(-5570.98389, 335.326996, -5964.75684))
...
Chest:CreateToggle({
	Title = "Auto Collect Chest [ Tween ]",
...
Chest:CreateToggle({
	Title = "Auto Collect Chest [ Bypass ]",
	Value = _G.Settings.Chest,
	Callback = function(value)
		_G.Settings.Chest = value
		SaveSettings()
end})
        ...
        if _G.Settings.Chest then
            ...
            if player and player.Character then
                ...
                local humanoid = character:FindFirstChild("Humanoid")
                    ...
                    local thayboosnguuukia = _G.Settings.Stop
...
spawn(function() 
    while _G.TrialDraco do
        for _, target in ipairs(targets) do 
            ...
            until distance and distance <= 3 or not _G.TrialDraco
