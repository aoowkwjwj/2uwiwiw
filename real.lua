...
BFully:CreateToggle({
    Title = "Auto Farm Darkbeard [ Fully ]",
...
BFully:CreateToggle({
    Title = "Auto Farm Darkbeard [ Fully ]",
    Value = _G.Settings.Dark,
    Callback = function(value)
        _G.AutoCollectChest = value
        _G.FullyDark = value
        _G.Settings.Dark = value
        SaveSettings()
        StopTween(_G.AutoCollectChest)
        StopTween(_G.FullyDark)
    end
})
...
spawn(function()
    while wait() do
        ...
        or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Fist of Darkness") then
            ...
            topos(CFrame.new(3778.69604, 14.8899994, -3499.44092))
            
            local DarkPos1 = CFrame.new(3778.69604, 14.8899994, -3499.44092)
            _G.FullyDark = true
            spawn(function()
                while wait() do
                    if _G.FullyDark then
                        pcall(function()
                     ...
                     thêm                       topos(v.HumanoidRootPart.CFrame * CFrame.new(0, 20, 0))
                                            game:GetService("VirtualUser"):CaptureController()
                                            game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                        until not _G.FullyDark or not v.Parent or v.Humanoid.Health <= 0
